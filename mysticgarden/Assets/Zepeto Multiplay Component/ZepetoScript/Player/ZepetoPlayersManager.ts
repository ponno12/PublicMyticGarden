...
import { SpawnInfo, ZepetoPlayer, ZepetoPlayers, ZepetoCharacter } from 'ZEPETO.Character.Controller';
import { State, Player } from "ZEPETO.Multiplay.Schema";
import { GameObject, Object, Quaternion, Vector3, WaitForSeconds, Animator } from 'UnityEngine';
import PlayerSync from './PlayerSync';
import TransformSyncHelper, { PositionExtrapolationType, PositionInterpolationType } from '../Transform/TransformSyncHelper';
import { Define } from '../../../_Scripts/Define';
...
export default class ZepetoPlayersManager extends ZepetoScriptBehaviour {
    ...
    GameMoving(dir: bool) {
        ...
        if(dir){
            this.myCharacter.transform.position += new Vector3(-0.6, 0, 1);
